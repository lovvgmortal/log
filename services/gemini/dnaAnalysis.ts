...
import { DNA_SYSTEM_PROMPT, DNA_REFINEMENT_SYSTEM_PROMPT, constructDnaPrompt, constructDnaRefinementPrompt, getLanguageInstruction } from "./prompts/index";
...
const dnaTemplate = {
  ...
  analysis: {
    ...
    structure_skeleton: [
      {
        ...
        micro_hook: "Mini-hook statement",
    ...
    hook_angle: {
      type: "Curiosity",
      description: "Psychological deconstruction of the hook with evidence."
    },
    ...
    linguistic_fingerprint: {
      role_persona: "The Rebel / The Mentor",
      tone_description: "Deep analysis of tone with specific examples",
      keywords: ["Keyword 1", "Phrase 2"],
      sentence_structure: "Description of sentence length and rhythm"
    },
    core_patterns: ["Pattern 1 - The 70% Safe Zone"],
    viral_x_factors: ["Anomaly 1 - The 30% Breakthrough Element"],
    content_gaps: ["Gap 1"],
...
const parseDnaResponse = (responseText: string, sources: ContentPiece[]): ScriptDNA => {
  ...
  try {
    ...
    console.error("DNA Parse Error", cleanText);
