               ...
               <div key={section.id} className="relative pl-14 group">
                  ...
                  <div className="bg-zinc-900/60 border border-white/10 rounded-3xl overflow-hidden shadow-xl">
                     ...
                     <div className="p-6">
                        ...
                        <textarea
                           className="w-full text-xs text-zinc-300 leading-relaxed bg-black/20 p-4 rounded-xl border border-white/5 focus:outline-none focus:border-blue-500/50 resize-y min-h-[100px]"
                           value={section.content_plan || ''}
                           onChange={(e) => onUpdateSection(section.id, { content_plan: e.target.value })}
                        />
